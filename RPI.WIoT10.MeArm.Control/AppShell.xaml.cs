...
using RPI.WIoT10.MeArm.Control.Controllers;
using RPI.WIoT10.MeArm.Control.Controls;
using RPI.WIoT10.MeArm.Control.Views;
...
namespace RPI.WIoT10.MeArm.Control
{
    /// <summary>
