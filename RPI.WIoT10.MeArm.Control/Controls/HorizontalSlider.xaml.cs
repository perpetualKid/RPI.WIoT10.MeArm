...
namespace RPI.WIoT10.MeArm.Control.Controls
{
    ...
    public sealed partial class HorizontalSlider : UserControl
    {
        /// <summary>Current distance (or "force"), from 0 to 100</summary>
        public static readonly DependencyProperty DistanceProperty =
            DependencyProperty.Register(nameof(Distance), typeof(int), typeof(HorizontalSlider), null);
        ...
        public static readonly DependencyProperty DistanceChangeThresholdProperty =
            DependencyProperty.Register(nameof(DistanceChangeThreshold), typeof(int), typeof(HorizontalSlider), null);
        ...
        public static readonly DependencyProperty ResetOnReleaseProperty =
            DependencyProperty.Register(nameof(ResetOnRelease), typeof(bool), typeof(HorizontalSlider), new PropertyMetadata(true));
