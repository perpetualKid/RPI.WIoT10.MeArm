...
namespace RPI.WIoT10.MeArm.Control.Controls
{
    public sealed partial class VerticalSlider : UserControl
    {
        ...
        public static readonly DependencyProperty DistanceProperty =
            DependencyProperty.Register(nameof(Distance), typeof(int), typeof(VerticalSlider), null);
        ...
        public static readonly DependencyProperty DistanceChangeThresholdProperty =
            DependencyProperty.Register(nameof(DistanceChangeThreshold), typeof(int), typeof(VerticalSlider), null);
        ...
        public static readonly DependencyProperty ResetOnReleaseProperty =
            DependencyProperty.Register(nameof(ResetOnRelease), typeof(bool), typeof(VerticalSlider), new PropertyMetadata(true));
